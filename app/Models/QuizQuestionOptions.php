...
class QuizQuestionOptions extends Model
{
    use HasFactory;
    use SoftDeletes;
    protected $fillable = ['uuid', 'name', 'quiz_question_id', 'is_correct'];
    ...
    public static function updateQuizQuestionOptions($request, $question)
    {


        $question_options_arr = array();

        $question_options = QuizQuestionOptions::where('quiz_question_id',  $question->id);
        ...
        QuizQuestionOptions::insert($question_options_arr);
    }
}
